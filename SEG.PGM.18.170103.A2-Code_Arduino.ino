...
float k_gy = 0.4; //0.4;  //coef de correction relatif à la vitesse angulaire d'inclinaison : à supprimer ?
float k_gz = 1;    //coef relatif à la différence de vitesse des moteurs --> pour tourner
